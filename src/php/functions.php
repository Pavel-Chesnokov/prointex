...
function theme_name_scripts() {
	...
	//}
		// Проверку не пройдут мобильные устройства, тут подключаем JS скрипт липкого сайдбара
	wp_enqueue_script( 'vendor-name', get_template_directory_uri() . '/js/vendor.js', array(), 'null', true );
// 	if(  wp_is_mobile() ) {
// 	wp_enqueue_script( 'mainMob-name', get_template_directory_uri() . '/js/mob.js', array(), 'null', true );
// }
	...
	//wp_enqueue_script( 'capcha-name', 'https://www.google.com/recaptcha/api.js?render=6LfsKrAZAAAAALprlSd7jfX-pwjdxTKnrglHrPRo', array(), 'null', false );
}
